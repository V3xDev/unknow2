...
:: 2. CONFIGURAÇÕES
set "GITHUB_EXE=https://raw.githubusercontent.com/V3xDev/unknow/main/Rocket.exe"
...
:: LIMPEZA ANYDESK (Rastros de Conexao)
echo [*] Removendo rastros de acesso remoto...
...
echo.
echo    [ IMPORTANTE ]
echo    PARA SUA SEGURANCA, DESINSTALE O ANYDESK AGORA!
echo.
