@echo off
:: ========================================
::  INSTALADOR ROCKET - VERSÃO FINAL
...
:: ========================================
:: [2/6] VERIFICAR ROCKET.EXE NO GITHUB
:: ========================================
echo [2/6] Verificando Rocket.exe no GitHub...
...
:: ========================================
:: [3/6] BAIXAR ROCKET.EXE
:: ========================================
echo [3/6] Baixando Rocket.exe...
...
echo [AVISO] Tarefa pode nao ter sido criada corretamente.
echo [INFO] Execute o instalador novamente se necessario.
echo.
